...
// this.bankCode = 0
  ...
  getClosedAccountCodesbyYear(){
    ...
    if(this.bankCode === '99') {
      ...
      this.entityService.getAllAccountsCodeByYear(this.fyStart,this.fyEnd).subscribe((res:any)=>{
        this.spinner.hide();
  ...
  downloadRecord(){
    ...
    this.spinner.show();
    this.entityService.downloadClosedAccountsData(bankCode,fyEnd,qtrEnd,isView).subscribe((res:any)=>{
...
localStorage.setItem("accountsView",'ClosedAccountView');
  ...
  onCellClicked(event: CellClickedEvent) {
    ...
    let bankCode = this.celldata.bank.split('-')[0].trim();
    localStorage.setItem('uploadClosedDatabankCode',bankCode);
