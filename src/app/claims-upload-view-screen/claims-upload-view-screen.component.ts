...
export class ClaimsUploadViewScreenComponent {
  ...
  getDataView() {
    let fyEnd = localStorage.getItem('claimsfyEnding');
    this.fyEnd =this.datePipe.transform(fyEnd,'dd-MM-yyyy')
    let qtrEnd :any= localStorage.getItem('claimsqtrEnding');
    ...
    this.bankcode =localStorage.getItem('bankCodeUser');
    // let accountDataStatusId = localStorage.getItem('accountDataStatusId');


    let isView = JSON.stringify(true)
this.spinner.show();
    this.entityService.viewaccountscreenclaimsdata(this.bankcode, this.fyEnd, this.qtrEnd, isView).subscribe((response: any) => {
